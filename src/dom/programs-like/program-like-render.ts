...
import ProgramLike from '../../types/programs-like/ProgramLike.js';
import ProgramLikeElement from '../../types/programs-like/ProgramLikeElement.js';
import draggableProgramsLike from './draggable-programs-like.js';

function createProgramLikeWrapper(programLike: ProgramLike, content?: HTMLDivElement): ProgramLikeElement {

    const dplLength: number = DraggableProgramLike.getProgramsLike().length;

    const programLikeWrapper = document.createElement('div') as ProgramLikeElement;
    ...
    const programLikeContainer: HTMLDivElement = document.createElement('div');
...
function renderProgramLike(programLike: ProgramLike, programLikeContent?: HTMLDivElement): ProgramLikeElement {
    const programLikeWrapper: ProgramLikeElement = createProgramLikeWrapper(programLike, programLikeContent);
    return programLikeWrapper;
}
